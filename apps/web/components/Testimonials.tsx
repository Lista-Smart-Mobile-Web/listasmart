      ...
      <div className="testi-layout">
        <div className="testi-featured reveal" style={{ transitionDelay: '.1s' }}>
          ...
          <div className="tf-author">
            <div className="tf-av" style={{ background: 'linear-gradient(135deg,var(--amber-lt),var(--amber))', fontSize: '16px', fontWeight: 800, color: '#1a0d00' }}>M</div>
            <div>
          ...
          {[
            {
              ...
              initial: 'A', bg: 'linear-gradient(135deg,#60A5FA,#2563EB)',
              name: 'Ana Beatriz Ferreira', role: 'Professora · Curitiba, PR',
              delay: '.12s',
            },
            {
              ...
              initial: 'R', bg: 'linear-gradient(135deg,#86EFAC,#16A34A)',
              name: 'Ricardo Souza', role: 'Engenheiro · Porto Alegre, RS',
              delay: '.16s',
            },
            {
              ...
              initial: 'J', bg: 'linear-gradient(135deg,var(--amber-lt),var(--amber))',
              name: 'João Pimentel', role: 'Gerente comercial · Supermercado Bom Preço',
              avatarColor: '#1a0d00',
              delay: '.2s',
            },
          ].map((t) => (
            <div key={t.name} className="tl-card reveal" style={{ transitionDelay: t.delay }}>
              ...
              <div className="tl-author">
                <div className="tl-av" style={{ background: t.bg, color: t.avatarColor || undefined }}>{t.initial}</div>
                <div>
